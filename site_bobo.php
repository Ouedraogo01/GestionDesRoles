...
//                                     WHERE lieu.id_ville = 6 AND text.id_ville = 6 AND 
//                                     carou.id_ville = 6 AND sponsors.id_ville = 6');
                        ...
                        <div class="col-md-12 col-sm-12  ">
                            <div class="table-responsive">
                                <table class="table table-striped jambo_table bulk_action" style="widht: 100%;">
                                    ...
                                    <?php
                                    $req = $connexion->prepare('SELECT * FROM lieu WHERE id_ville = 6');
                                    ...
                                    <?php
                                    $req = $connexion->prepare('SELECT * FROM text WHERE id_ville = 6');
                                    ...
                                    <?php
                                    $req = $connexion->prepare('SELECT * FROM carou WHERE id_ville = 6');
                                    ...
                                    <?php
                                    $req = $connexion->prepare('SELECT * FROM sponsors WHERE id_ville = 6');
