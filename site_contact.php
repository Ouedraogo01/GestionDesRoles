...
$req = $connexion->prepare('SELECT * FROM inscription');
                                    ...
                                    <?php if ($req->execute()) {
                                        ...
                                        if ($resultat) {
                                            ...
                                            <tr class='headings'>
                                                ...
                                                <th class='column-title'>id_inscri</th>
                                                <th class='column-title'>Nom</th>
                                                <th class='column-title'>Email</th>
                                                <th class='column-title'>Objet</th>
                                            ...
                                            foreach ($resultat as $row) {
                                                ...
                                                echo "<a name='suppcontact' href='traitementcontact.php?id_contact=" . $row['id_inscri'] . "'><i class='fas fa-trash m-2' style='color: red;'></i></a>";
